package com.example.vina.model;

import java.io.Serializable;

public class DataFremwork implements Serializable {
    String nameFramework, original_author, official_web,  description, image;

    public DataFremwork(String nameFramework, String original_author, String official_web, String description, String image) {
