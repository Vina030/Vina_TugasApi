...
public class MainActivity extends AppCompatActivity {
    ...
    void setupListview () {
        ...
        AdaptetFremwork adapter = new AdaptetFremwork(this, dataFrameworks);
    ...
    private AdapterView.OnItemClickListener onItemClick = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            DataFremwork fSELECTED = dataFrameworks.get(position);
            Intent intent = new Intent(MainActivity.this, DetailFremwork.class);
    ...
    void refreshView() {
        ...
        while(key.hasNext()) {
            ...
            try {
                ...
                dataFrameworks.add(new DataFremwork(nameFramework, author, official_web, des, img));
